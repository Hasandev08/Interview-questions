## 1- You have two identical ropes, one rope can burn in 60 mins, but burnning pattern is irregular mean maybe first half of the rope can be burn in 50 mins and other half can be in 10 mins, you have to calculate 45 mins using the ropes.
```
